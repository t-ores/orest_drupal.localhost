 ...
 * @endcode
 */
$settings['hash_salt'] = 'OjDpsxA_XOOudk9hXi2U2SQV7lYvSzlMIwOBQDQwqiqevULUYD4vOUD5TVEqnnrVa5aUwHSJYw';
...
if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
  //var_dump($app_root .'/'. $site_path . '/settings.local.php');
